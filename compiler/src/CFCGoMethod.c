...
CFCGoMethod_init(CFCGoMethod *self, CFCMethod *method) {
    ...
    char *perl_name = CFCGoMethod_perl_name(method);
...
#if 0
char*
CFCGoMethod_perl_name(CFCMethod *method) {
...
S_invalid_callback_def(CFCMethod *method) {
    ...
    char pattern[] =
        ...
        "}\n";
    char *callback_def
        = CFCUtil_sprintf(pattern, override_sym, override_sym, ret_type_str,
                          override_sym, params, unused, full_method_sym,
                          unreachable);
